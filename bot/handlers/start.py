...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/verify — Verify your emergency contacts' consent\n"
        ...
        "/export — Export your data (GDPR/NDPR)\n"
        ...
        "3. If your phone is lost/stolen, anyone can message this bot and enter your PIN to contact your loved ones.\n\n"
